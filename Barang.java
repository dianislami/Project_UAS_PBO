...
public class Barang {
    ...
    // Metode untuk menghitung harga dengan diskon
    public double hitungHargaDenganDiskon(int jumlah) {
        double total = hargaBarang * jumlah;
        if (jumlah >= 10) {
            total *= 0.9; // Diskon 10% jika beli lebih dari atau sama dengan 10
        } else if (jumlah >= 5) {
            total *= 0.95; // Diskon 5% jika beli lebih dari atau sama dengan 5
        }
        return total;
    }
