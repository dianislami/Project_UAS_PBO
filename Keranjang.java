...
public class Keranjang {
    ...
    public void hapusBarang(String id) {
        for (Barang b : barang) {
            if (b.getIdBarang().equals(id)) {
                List<Barang> daftarBarangUtama = Barang.bacaDataBarang();
                for (Barang barangUtama : daftarBarangUtama) {
                    if (barangUtama.getIdBarang().equals(id)) {
                        barangUtama.tambahStok(b.getStokBarang());
                        Barang.simpanDataBarang(daftarBarangUtama);
                        break;
                    }
                }
                barang.remove(b);
    ...
    // Method to save cart data to file
    ...
    // Method to load cart data from file
